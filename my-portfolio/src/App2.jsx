      ...
      <div style={{ ...textStyle, textAlign: "center", position: "relative", zIndex: 1 }}>
        ...
        <p style={{
          ...
          I am a Software Engineering graduate. A motivated Mobile Application | AI & Automation | Web Developer.
                  ...
                  <a
            href="mailto:resyalizatul@gmail.com"
            style={{
              display: "inline-block", // Ensures padding and margins behave like a button
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.color = TOKENS.colorAccent;
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.background = TOKENS.colorAccent;
              e.currentTarget.style.color = TOKENS.colorBg;
            }}
          >
            Get in Touch
          </a>
